<div>
	<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
		<h1 class="text-4xl font-semibold px-4 sm:px-6 lg:px-8 mx-auto" >
			Products categories
		</h1>
		<div class="max-w-[85rem] px-4  sm:px-6 lg:px-8 lg:py-10 mx-auto">
			...
			<div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6">
				...
				<a class="group flex flex-col
				bg-white border shadow-sm rounded-xl hover:shadow-md transition
