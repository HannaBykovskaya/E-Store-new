<div>
	<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
		<h1 class="text-4xl font-semibold pb-10  mx-auto">
			Checkout
		</h1>
		<form wire:submit.prevent='placeOrder'>
		<div class="flex grid grid-cols-12 gap-4">
			<div class="md:col-span-12 lg:col-span-8 col-span-12 flex">
				<!-- Card -->
				<div class="bg-white rounded-xl shadow p-4 sm:p-7
				 dark:bg-slate-900 w-full">
					...
					<div class="mb-6">
						...
						<div class="mt-4">
							...
							<input class="w-full rounded-lg
							 border py-2 px-3 dark:bg-gray-700
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						<li>
							<input class="hidden peer" id="hosting-small"
							 ...
							 rounded-lg cursor-pointer dark:hover:text-gray-300
							  dark:border-gray-700 dark:peer-checked:text-blue-500
							   peer-checked:border-blue-600 peer-checked:text-blue-600
								...
								<svg aria-hidden="true" class="w-5 h-5 ms-3 rtl:rotate-180"
						...
						<li>
							<input class="hidden peer" id="hosting-big"
							wire:model='payment_method'
							type="radio"
							value="stripe">
							<label class="inline-flex items-center
							justify-between w-full p-5 text-gray-500
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12 flex flex-col space-y-4">
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900 w-full">
				...
				<button type='submit'
				 class="bg-green-500 my-2 w-full p-3 rounded-lg text-lg
