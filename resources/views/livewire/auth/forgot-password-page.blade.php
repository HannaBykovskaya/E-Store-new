		  ...
		  <main class="w-full max-w-md mx-auto p-6">
			<div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
			  <div class="p-4 sm:p-7">
				...
				<div class="mt-5">
				  <!-- Form -->
			  <form wire:submit.preventt='save'>
					@if(session('success'))
					<div class="mt-2 mb-4  bg-teal-500 text-sm text-white rounded-lg p-4" role="alert" tabindex="-1" aria-labelledby="hs-solid-color-success-label">
					...
					<div class="grid gap-y-4">
					  ...
					  <div>
						...
						<div class="relative">
						  ...
						  wire:model="email" class="py-3 px-4 block w-full border
